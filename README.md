# Hi there, I'm Hacer Aktaş 👋

An enthusiastic **Electrical-Electronics Engineering Student** deeply passionate about **Power Electronics** and **Hardware Design**. I love bringing hardware concepts to life, from advanced converter topologies to multi-layer PCB design and embedded microcontroller applications.
...
* **Power Electronics:** Design, control, and simulation of DC-DC converter topologies (SEPIC, Buck-Boost), MPPT algorithms, and high-efficiency Power Delivery Networks (PDN).
* **Hardware Engineering:** Schematic capture, multi-layer high-speed/power PCB layout design, component selection, and signal integrity.
* **Embedded Control:** Developing firmware for microcontrollers, sensor integration, and real-time control applications.
